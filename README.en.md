...
[Hub Address](https://hub.docker.com/repository/docker/qidian99/chatgpt-web/general)
...
services:
  app:
    image: qidian99/chatgpt-web # always use latest, pull the tag image again when updating
    ports:
      - 3002:3002
    environment:
      # one of two
